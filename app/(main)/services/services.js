  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-16 relative">
      ...
      {savedServices.length > 0 && (
        <div className="fixed bottom-4 right-4 bg-background shadow-lg p-4 rounded-lg z-50">
      ...
      {showSavePopup && (
        <div className="fixed bottom-4 left-4 bg-background shadow-lg p-4 rounded-lg z-50 animate-fade-in">
          <div className="flex items-center justify-between">
            <div>
              <h4 className="text-lg font-semibold">Service Saved</h4>
